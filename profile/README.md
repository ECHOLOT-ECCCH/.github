...
- Source Systems: Local repositories and databases of CH institutions.
- Target Systems: DS4CH/Europeana aggregators, Wikimedia ecosystem (Wikidata, Wikimedia Commons).
- Reference Resources: Controlled vocabularies, thesauri, gazetteers (e.g., GND, Geonames, VIAF).
- Hosting Infrastructure: During the project ECHOLOT system will be deployed on the server infrastructure of selected project partners. Once ready, it should also be deployable as a vertical application on the ECCCH cloud infrastructure.

## Work programme

![Intersection-ECHOLot-WPs](/src/assets/Intersection-ECHOLOT-WPs.png)
